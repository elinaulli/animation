export default class Logic {
	...
	hidePopover(e) {
		if (
			e.target !== this.gui.button &&
			!this.gui.popover.contains(e.target) &&
			!this.gui.popover.classList.contains("hidden")
		) {
			this.gui.popover.classList.remove("show");
			this.gui.popover.classList.add("hiding");
		}
	}
